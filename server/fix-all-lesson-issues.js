        ...
        for (const lesson of allLessons) {
            ...
            if (comprehensiveLessonFixes[cleanTitle] && comprehensiveLessonFixes[cleanTitle][gradeKey]) {
                ...
                await collection.updateOne(
                    ...
                    {
                        $set: {
                            'content.introduction': fix.introduction,
                            'content.mainContent': fix.mainContent,
                            'content.activities': fix.activities,
                            'content.funFacts': fix.funFacts
                        }
                    }
                );
                ...
                const hasFormattingIssues = !content.includes('##') && !content.includes('\n\n');
                ...
                if (hasGenericActivities || hasFormattingIssues) {
                    ...
                    await collection.updateOne(
                        ...
                        {
                            $set: {
                                'content.introduction': newContent.introduction,
                                'content.mainContent': newContent.mainContent,
                                'content.activities': newContent.activities,
                                'content.funFacts': newContent.funFacts
                            }
                        }
                    );
