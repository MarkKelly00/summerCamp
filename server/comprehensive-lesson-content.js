...
// Each lesson follows the exact structure of "Skip Counting by 5s"
...
Animals live in habitats that meet their needs, and they have special adaptations (like superpowers) that help them survive. Every animal is perfectly designed for its home!`,
    ...
    "Weather Patterns and Observation": {
        grade2: {
            introduction: "Get ready to become a weather detective! We're going to learn how to observe and understand weather patterns. Weather is what's happening outside right now - is it sunny, rainy, cloudy, or windy? Let's discover how to be weather forecasters!",
            content: `**What Are Weather Patterns and Observation?**

Weather patterns are the different types of weather we see over time, and observation means watching and recording what we notice. Weather includes things like rain, sun, wind, clouds, and temperature. Patterns help us predict what might happen next!

**Why Weather Patterns and Observation Matter**

Understanding weather helps you know what to wear, what activities you can do outside, and keeps you safe. Weather affects farmers growing food, pilots flying planes, and families planning picnics!

**How Weather Patterns and Observation Work**

We observe weather by looking at:
• **Temperature:** Is it hot, warm, cool, or cold?
• **Precipitation:** Is it raining, snowing, or dry?
• **Wind:** Is it still, breezy, or very windy?
• **Clouds:** Are there fluffy white clouds, dark storm clouds, or clear skies?

Weather patterns repeat:
• Sunny days often follow rainy days
• Clouds usually come before rain
• Wind often brings weather changes
• Seasons have typical weather patterns

**Real-Life Examples**

• Dark clouds usually mean rain is coming
• Red sky at night often means nice weather tomorrow
• Animals sometimes act differently before storms
• Weather vanes show which direction the wind is blowing

**Common Mistakes to Avoid**

Don't assume weather will stay the same all day - it can change quickly! Also, clouds don't always mean rain - some clouds are just puffy and white.

**Quick Recap**

Weather patterns help us understand and predict what the weather will do. By observing temperature, precipitation, wind, and clouds, we can become weather detectives!`,
            activities: [
                "Create a daily weather chart and record observations for a week using pictures and words",
                "Make simple weather instruments like a wind sock or rain gauge",
                "Go outside and use your senses to observe the weather - what do you see, feel, hear, and smell?",
                "Draw pictures of different types of clouds and learn their names (cumulus, stratus, cirrus)",
                "Start a weather journal with daily drawings and predictions about tomorrow's weather"
            ],
            funFacts: [
                "Did you know that no two snowflakes are exactly alike - each one has a unique pattern!",
                "Lightning is actually hotter than the surface of the sun!",
                "A single thunderstorm cloud can weigh as much as 100 elephants!",
                "Weather satellites in space help meteorologists predict weather from 240 miles above Earth!",
                "Some animals like cows often lie down before it rains because they can sense the air pressure changing!"
            ]
        }
    },
...
Community helpers are important people who take care of our neighborhoods. Some helpers have been around forever, some have changed how they work, and some are brand new. They all help make our community strong!`,
    ...
    // I'll continue with a few more key lessons to establish the pattern
...
module.exports = comprehensiveLessonContent; 